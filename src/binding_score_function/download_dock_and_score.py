...
def main() -> None:
    ...
    logger.info(f"Preprocessing completed. Number of PDB files: "
    ...
    scores_file = os.path.join(paths["processed_dir"], "scores.csv")
    ...
    output_merge_file = os.path.join(paths["output_dir"], "scores_and_affinity.csv")
